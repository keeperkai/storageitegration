<center>
<ul id="filesystempanel" class="ztree" data-toggle="context" data-target="#rightclickdialog"></ul>
<div id='fileuploadpanel' hidden>
選擇上傳檔案:<input type="file" name="file" id="file" onchange='return upload();'/>
</div>
<div id='rightclickdialog'>
<ul id='rightclickmenu' class='dropdown-menu' role='menu'>
<li onclick='return showFilenameDialog();'><a tabindex="-1" href="#">新增資料夾</a></li>
...
<div data-toggle="context" data-target="#rightclickdialog">
	This is test text
<div>
