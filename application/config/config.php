...
|
*/
$config['base_url']	= 'https://storageintegration.twbbs.org/';
...
/*
This is a map for files, it maps files by extension as key to:
(i)the file group(the highest functionality possible hosted in all the storage providers): 'editable', 'previewable', 'none'
(ii)an array, the cloud storage providers that can supply the functionality of (i)
Ex:
array('highest_functionality'=>'previewable', 'capable_providers'=>array('googledrive', 'onedrive'))
*/
/*
$config['storage_provider_capability_map'] = array(
    'xls'=>array('highest_functionality'=>'editable', 'capable_providers'=>array('onedrive')),//can't multi-edit
    'xlsx'=>array('highest_functionality'=>'editable', 'capable_providers'=>array('onedrive')),
    'ppt'=>array('highest_functionality'=>'editable', 'capable_providers'=>array('onedrive')),//can't multi-edit
    'pptx'=>array('highest_functionality'=>'editable', 'capable_providers'=>array('onedrive')),
    'doc'=>array('highest_functionality'=>'editable', 'capable_providers'=>array('onedrive')),//can't multi-edit
    'docx'=>array('highest_functionality'=>'editable', 'capable_providers'=>array('onedrive')),
    
    'odt'=>array('highest_functionality'=>'editable', 'capable_providers'=>array('googledrive')),//onedrive can edit too, but can't support multi-edit, we will need to think about this.
    ''
);
*/
/*
map for storage providers and their capabilities for each type of extension/other aspects like max file size and such
*/
